...
function ProductDesignSection() {
    const products = [
        ...
        {
            image:{link: 'https://cinnamon.agency/_next/image?url=https%3A%2F%2Fimages.ctfassets.net%2F6mf4aqitzrkt%2F7kFgIXzEEYLIM678mr3mzo%2F6401985a011c0ae2ce0b3f940499f4c1%2Fthumbnail.png&w=1200&q=80',
            imageColor: 'bg-primaryAmber',},
            tags: ['PRODUCT DESIGN' ,'WEB DEVELOPMENT', 'QUALITY ASSURANCE'],
            title: 'Ukulele:\nThe largest ukulele tabs archive',
            description: 'Ukulele is the number one ukulele community, where players of any level can find the most complete tabs and chords. Cinnamon offered a complete platform redesign including expansions and new features, focusing on keeping the user longer on the website. Our services Product design'
