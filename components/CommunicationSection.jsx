...
function CommunicationSection() {
  ...
  <p className='text-[175px] font-mont-heavy text-[#EDEAFF] -z-10  absolute top-8 left-16'>“</p>
    <div className='flex lg:flex-row flex-col justify-between'>
    <div className='flex flex-col gap-8 lg:max-w-[70%]'>
   <h1 className='text-3xl lg:text-5xl font-mont-bold'>They’re consistent, and the communication is good.</h1>
   <p className='lg:max-w-[80%] font-mont'>When I have a deadline, they would work extra hours on the weekend and after hours. Cinnamon gives the impression of being a smaller team that’s focused on customers.
</p>
...
<div className='flex w-32 justify-between'>
    ...
    <div >
     <Image className='hidden lg:flex flex-col justify-between' width={200} height={200} src='/assets/ping.png' alt='piung'/>
