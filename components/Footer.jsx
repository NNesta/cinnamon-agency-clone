...
function Footer() {
  return (
    ...
    <div className='container mx-auto px-12 lg:px-16 text-primaryWhite pt-32'>
      ...
      <h1 className='text-4xl font-mont-bold leading-normal max-w-[80%]'>All software, zero bullshit.</h1>
      </div>
      ...
      <li>Blog</li>
        ...
        <div className='flex flex-col gap-4'>
          <h1 className='text-xl font-mont-semibold text-white'>New York</h1>
          <ul className='flex flex-col gap-3 text-sm'>
        ...
        <div className='flex flex-col gap-4'>
          <h1 className='text-xl font-mont-semibold text-white'>Belgrade</h1>
          <ul className='flex flex-col gap-3 text-sm'>
     ...
     <div className='flex flex-col gap-8 order-1 lg:order-2  w-72'>
        ...
        <input placeholder='Your email' className='bg-transparent outline-none border-white border-b ' type='text'/>
    <Button>Subscribe</Button>
      </div>
     <div className="flex flex-col gap-4 order-2 lg:order-3 w-[180px]">
     <Image src='/assets/pangea.svg' width={180} height={180} alt='footer-image'/>
     <Image src='/assets/clutch.webp' width={180} height={180} alt='footer-image'/>
      </div>
      </div>
     ...
     <p>© 2022 Cinnamon</p>
     <Link className='flex-1 underline' href='/'>Privacy Policy</Link>  
     </div>
